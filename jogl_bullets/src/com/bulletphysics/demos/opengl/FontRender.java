...
public class FontRender {
	...
	public static class GLFont {
		...
		protected void save(File f) throws IOException {
			...
			gl.glGetTexImage(GL2.GL_TEXTURE_2D, 0, GL2.GL_RGBA, GL2.GL_UNSIGNED_BYTE, (ByteBuffer)buf.position(0));
			buf.get(data);
			out.write(data);
		...
		protected void load(InputStream _in) throws IOException {
			...
			gl.glTexImage2D(GL2.GL_TEXTURE_2D, 0, GL2.GL_RGBA, w, h, 0, GL2.GL_RGBA, GL2.GL_UNSIGNED_BYTE, (ByteBuffer)buf.position(0));
