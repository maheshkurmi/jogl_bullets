...
public abstract class ConvexShape extends CollisionShape {
    ...
    protected abstract void batchedUnitVectorGetSupportingVertexWithoutMargin(Vector3f[] vectors, Vector3f[] supportVerticesOut, int numVectors);
    //#endif

    protected abstract void getAabbSlow(Transform t, Vector3f aabbMin, Vector3f aabbMax);
