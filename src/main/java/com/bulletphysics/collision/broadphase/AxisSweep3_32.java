...
public class AxisSweep3_32 extends AxisSweep3Internal {
	...
	private AxisSweep3_32(Vector3f worldAabbMin, Vector3f worldAabbMax, int maxHandles/* = 1500000*/, OverlappingPairCache pairCache/* = 0*/) {
	...
	protected static class HandleImpl extends Handle {
		...
		public void setMinEdges(int edgeIndex, int value) {
            switch (edgeIndex) {
                case 0 -> minEdges0 = value;
                case 1 -> minEdges1 = value;
                case 2 -> minEdges2 = value;
            }
		}
		...
		public void setMaxEdges(int edgeIndex, int value) {
            switch (edgeIndex) {
                case 0 -> maxEdges0 = value;
                case 1 -> maxEdges1 = value;
                case 2 -> maxEdges2 = value;
            }
		}
	}
